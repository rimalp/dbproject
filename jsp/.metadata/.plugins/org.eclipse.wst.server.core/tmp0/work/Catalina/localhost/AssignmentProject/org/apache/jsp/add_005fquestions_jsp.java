...
out.println(e); 
 ...
 out.println(section); 
      ...
      out.write("\n");
      out.write("<form method=\"post\" action=\"make_assignment_servlet?questions=DONE\">\n");
 int qs = Integer.parseInt((String)request.getAttribute("numQs")); 
for(int i=0; i<qs; i++){//assume 4 answers per question for now
      out.write('\n');
 out.println((i+1)+") "); 
      out.write("Enter question: ");
 out.println("<input type=\"text\" name=\"question"+i+"\">"); 
      out.write("<br/>\n");
      out.write("Enter up to 4 potential answers:<br/>\n");
      out.write("1) ");
 out.println("<input type=\"text\" name=\"answer"+i+"a\">"); 
      out.write("<br/>\n");
      out.write("2) ");
 out.println("<input type=\"text\" name=\"answer"+i+"b\">"); 
      out.write("<br/>\n");
      out.write("3) ");
 out.println("<input type=\"text\" name=\"answer"+i+"c\">"); 
      out.write("<br/>\n");
      out.write("4) ");
 out.println("<input type=\"text\" name=\"answer"+i+"d\">"); 
      out.write("<br/>\n");
      out.write("Path of any images to be displayed with this problem: <input type=\"text\"><br/>\n");
      out.write("<br/>\n");
      out.write("<table>\n");
      out.write("<tr>\n");
      out.write("<td>Mark any correct answers:</td>\n");
      out.write("<td>1)<input type=\"checkbox\" name=\"correct\" value=\"1\"></td>\n");
      out.write("<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2)<input type=\"checkbox\" name=\"correct\" value=\"2\"></td>\n");
      out.write("</tr>\n");
      out.write("<tr>\n");
      out.write("<td></td>\n");
      out.write("<td>3)<input type=\"checkbox\" name=\"correct\" value=\"3\"></td>\n");
      out.write("<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;4)<input type=\"checkbox\" name=\"correct\" value=\"4\"></td>\n");
      out.write("</tr>\n");
      out.write("</table>\n");
      out.write("<br/>\n");
} 
      out.write("\n");
      out.write("<input type=\"Submit\" name=\"done\" value=\"Save Assignment\">\n");
      out.write("</form>\n");
      out.write("\n");
      out.write("\n");
      out.write("\n");
