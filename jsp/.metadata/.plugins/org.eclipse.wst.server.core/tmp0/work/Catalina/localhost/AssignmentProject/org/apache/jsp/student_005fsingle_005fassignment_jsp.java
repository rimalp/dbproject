...
public final class student_005fsingle_005fassignment_jsp extends org.apache.jasper.runtime.HttpJspBase
...
out.println("<input type=\"radio\" name=\"answer"+q+"\" value=\""+questions[i][3]+"\" "+c+">"+questions[i][1]); 
      out.write("<br/>\n");
 num++;
i++;
}
q++;
      ...
      out.write("\n");
      out.write("\n");
      out.write("<input type=\"Submit\" name=\"Save\" value=\"Save\"> <input type=\"Submit\" name=\"Submit\" value=\"Submit\">\n");
      out.write("<!-- do we want a save button ?? (maybe later if time... need to change db)\n");
      out.write("when submited, update the assigned table in the db -->\n");
      out.write("\n");
      out.write("\n");
