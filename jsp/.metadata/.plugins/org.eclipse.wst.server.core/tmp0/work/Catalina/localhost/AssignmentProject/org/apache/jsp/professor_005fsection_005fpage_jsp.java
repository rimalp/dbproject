...
public final class professor_005fsection_005fpage_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(assignments[i][0] != null){
      ...
      out.write("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\n");
 out.println("<a href=\"professor_assignment_servlet_path?id="+assignments[i][3]+"\">"+assignments[i][0]+"</a>"); 
      out.write("</td>\n");
 ...
 out.println(assignments[i][2]); 
      ...
      out.write("</table>\n");
      out.write("\n");
      out.write("<!-- option to add an assignment HERE -->\n");
      out.write("<br/>\n");
      out.write("\n");
      out.write("<form method=\"post\" action=\"make_assignment_servlet?new=");
 out.println(request.getAttribute("CRN")); 
      out.write('"');
      out.write('>');
      out.write('\n');
      out.write("\n");
      out.write("<input type=\"Submit\" name=\"newAssignment\" value=\"Add Assignment\">\n");
      out.write("<!-- <button name=\"newAssignment\" type=\"button\">Add Assignment</button> -->\n");
      out.write("</form>\n");
      out.write("\n");
      out.write("\n");
      out.write("<br/>\n");
